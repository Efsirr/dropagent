...
const LABELS = {
  en: {
    ...
    "nav.reports": "Reports",
    "nav.tools": "Tools",
    "phase.research_desc": "Discover what's moving and save the best signals",
    "phase.track_desc": "Monitor prices, watchlist, and competitor movement",
    "phase.reports_desc": "Preview today's digest and weekly category direction",
    "phase.tools_desc": "Check margins and export results to your channels",
  ...
  ru: {
    ...
    "phase.research_desc": "Находите тренды и сохраняйте лучшие сигналы",
    "phase.track_desc": "Мониторинг цен, списка отслеживания и конкурентов",
    "phase.reports_desc": "Просмотр дайджеста и еженедельного отчёта",
    "phase.tools_desc": "Проверяйте маржу и экспортируйте результаты",
    "activity.label": "Недавняя активность",
  ...
  zh: {
    ...
    "nav.reports": "报告",
    "nav.tools": "工具",
    "phase.research_desc": "发现市场动向，保存最佳信号",
    "phase.track_desc": "监控价格、观察列表和竞争对手动态",
    "phase.reports_desc": "预览今日摘要和每周类别趋势",
    "phase.tools_desc": "检查利润率并将结果导出到您的渠道",
    "activity.label": "近期活动",
